...
# SECRET_KEY = "django-insecure-%k-h%s=lnfj8)ds=$kbbxez)*iu^7=yog^ng^3diubq&=wun25"
# SECURITY WARNING: keep the secret key used in production secret!
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "builtins": ["apps.incident_reporting.templatetags.custom_filters"],
        },
    },
]
